    ...
    return (
        <div>
            ...
            <div className="mx-auto max-w-3xl divide-y divide-gray-100 py-4 px-10 xl:px-0">
                {transactions.map(({ id, from, amount, description, transactionDate }) => (
                    <TransactionItem key={id} id={id} from={from} description={description} transactionDate={transactionDate} amount={amount} toggleTransactionDetailModal={toggleTransactionDetailModal} />
                ))}
