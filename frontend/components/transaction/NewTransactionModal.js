...
const NewTransactionalModel = ({ modalOpen, setModalOpen, userAddress, setQrCode }) => {
    ...
    useEffect(() => {
        ...
        console.log(cartPrice.toString());
        const url = "solana:https://94d9-2607-f470-6-3001-9197-a9be-765-5798.ngrok.io/api/" + userAddress + "/" + reference.toBase58() + "/createtransaction?amount=" + cartPrice.toString()
        ...
        <Modal modalOpen={modalOpen} setModalOpen={setModalOpen}>
            <div>
                ...
                {!confirmed && 
                    ...
                    <div className="flex flex-col items-center justify-center space-y-1">
                        <p className="text-lg font-medium text-gray-800">{confirmed ? "NFT Received!" : truncate(userAddress)}</p>
...
export default NewTransactionalModel
